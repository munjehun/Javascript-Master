...
obj1.price = 10;
objs.add(obj1);
console.log("퀴즈1 :", objs);
//(얕은 복사) Set(2) { { name: '🍊', price: 10 }, { name: '🍍', price: 3 } }
//obj를 추가하지 않고 obj1의 price만 수정해도 set의 obj1 price는 수정됨.

// 퀴즈
const obj3 = { name: "🍍", price: 3 };
objs.add(obj3); //obj2와 같은 값을 할당한 변수를 넣으면 어떻게 될까? obj3가 들어갈까?
console.log("퀴즈2 :", objs); //obj2와 obj3는 각각 다른 참조값을 가지므로 추가된다!
// Set(3) {{ name: '🍊', price: 10 },{ name: '🍍', price: 3 },{ name: '🍍', price: 3 }}

obj3.price = 12; //obj2의 price도 바뀔까??
console.log("퀴즈3 :", objs); //ㄴㄴ obj3의 price만 바뀐다.
